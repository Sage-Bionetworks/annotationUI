...
a. A key and it's associated values as a comma seperated list: ![](../img/format1.png)
b. A key and a value in each row with repeating keys for those whom have multiple values: ![](../img/format2.png)
